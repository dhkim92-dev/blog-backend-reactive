...
@Component
class AuthIdResolver : HandlerMethodArgumentResolver {
            ...
            .map { context ->
                ...
                if (principal is JwtPrincipal) {
                    when (parameter.parameterType) {
                        UUID::class.java -> UUID.fromString(principal.authId)
                        String::class.java -> principal.authId
                        Id::class.java -> Id.of(AuthInfo::class, UUID.fromString(principal.authId))
